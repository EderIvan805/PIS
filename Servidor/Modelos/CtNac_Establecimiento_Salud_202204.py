...
class CtNac_Establecimiento_Salud_202204(db.Model):
    ...
    Clave_Entidad = db.Column(db.TinyInteger, nullable=False)
    ...
    Clave_Jurisdiccion = db.Column(db.TinyInteger, nullable=False)
    ...
    Clave_Tipo_Establecimiento = db.Column(db.TinyInteger, nullable=False)
    ...
    Clave_Vialidad = db.Column(db.TinyInteger)
    ...
    Clave_Estatus_Operacion = db.Column(db.TinyInteger, nullable=False)
    ...
    Unidad_Movil_Clave_Tipologia = db.Column(db.TinyInteger)
    ...
    Clave_Nivel_Atencion = db.Column(db.TinyInteger, nullable=False)
    ...
    Clave_Estrato_Unidad = db.Column(db.TinyInteger, nullable=False)
    Tipo_Obra = db.Column(db.String(50))
    Clave_Tipo_Obra = db.Column(db.TinyInteger)
