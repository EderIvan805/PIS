...
class Nacimientos_ocurridos_2021(db.Model):
    ...
    Nacio_Extranjero = db.Column(db.TinyInteger, nullable=False)
    Entidad_Nacimiento = db.Column(db.TinyInteger, nullable=False)
    Municipio_Nacimiento = db.Column(db.SmallInteger, nullable=False)
    Edad = db.Column(db.SmallInteger, nullable=False)
    Se_Considera_Indigena = db.Column(db.TinyInteger, nullable=False)
    Habla_Lengua_Indigena = db.Column(db.TinyInteger, nullable=False)
    Fecha_Nacimiento_Madre = db.Column(db.String(20))
    Estado_Conyugal = db.Column(db.TinyInteger, nullable=False)
    Reside_Extranjero = db.Column(db.TinyInteger, nullable=False)
    Entidad_Residencia = db.Column(db.TinyInteger, nullable=False)
    ...
    Num_Embarazos = db.Column(db.TinyInteger, nullable=False)
    Hijos_Nacidos_Muertos = db.Column(db.TinyInteger, nullable=False)
    Hijos_Nacidos_Vivos = db.Column(db.TinyInteger, nullable=False)
    Hijos_Sobrevivientes = db.Column(db.TinyInteger, nullable=False)
    Condicion_Hijo_Anterior = db.Column(db.TinyInteger, nullable=False)
    Vive_Hijo_Anterior = db.Column(db.TinyInteger, nullable=False)
    Orden_Nacimiento = db.Column(db.TinyInteger, nullable=False)
    Atencion_Prenatal = db.Column(db.TinyInteger, nullable=False)
    Trimestre_Primer_Consulta = db.Column(db.TinyInteger, nullable=False)
    Total_Consultas = db.Column(db.TinyInteger)
    Sobrevivio_Parto = db.Column(db.TinyInteger, nullable=False)
    Afiliacion = db.Column(db.TinyInteger, nullable=False)
    Escolaridad = db.Column(db.TinyInteger, nullable=False)
    Interrumpio_Estudios = db.Column(db.TinyInteger, nullable=False)
    Clave_Ocupacion_Habitual = db.Column(db.SmallInteger, nullable=False)
    Trabaja_Actualmente = db.Column(db.TinyInteger, nullable=False)
    Edad_Padre = db.Column(db.TinyInteger)
    Fecha_Nacimiento = db.Column(db.Date, nullable=False)
    Hora_Nacimiento = db.Column(db.String(10), nullable=False)
    Sexo = db.Column(db.TinyInteger, nullable=False)
    Edad_Gestacional = db.Column(db.TinyInteger, nullable=False)
    Talla = db.Column(db.TinyInteger, nullable=False)
    Peso = db.Column(db.SmallInteger, nullable=False)
    Apgar = db.Column(db.TinyInteger, nullable=False)
    Silverman = db.Column(db.TinyInteger, nullable=False)
    Tamiz_Auditivo = db.Column(db.TinyInteger, nullable=False)
    Vacuna_BCG = db.Column(db.TinyInteger, nullable=False)
    Vacuna_Hepatitis_B = db.Column(db.TinyInteger, nullable=False)
    Vitamina_A = db.Column(db.TinyInteger, nullable=False)
    Vitamina_K = db.Column(db.TinyInteger, nullable=False)
    Producto_Embarazo = db.Column(db.TinyInteger, nullable=False)
    Orden_Producto = db.Column(db.TinyInteger)
    Total_Productos = db.Column(db.TinyInteger)
    Codigo_Anomalia1 = db.Column(db.String(10), nullable=False)
    Codigo_Anomalia2 = db.Column(db.String(10), nullable=False)
    Lugar_Nacimiento = db.Column(db.TinyInteger, nullable=False)
    Clues = db.Column(db.String(50))
    Tiempo_Traslado = db.Column(db.Time)
    Resolucion_Embarazo = db.Column(db.TinyInteger, nullable=False)
    Utilizo_Forceps = db.Column(db.TinyInteger, nullable=False)
    Tipo_Cesarea = db.Column(db.TinyInteger, nullable=False)
    Personal_Atendio = db.Column(db.TinyInteger, nullable=False)
    Tipo_Medico_Atendio = db.Column(db.TinyInteger)
    Entidad_Federativa_Parto = db.Column(db.TinyInteger, nullable=False)
    Municipio_Parto = db.Column(db.SmallInteger, nullable=False)
    Localidad_Parto = db.Column(db.SmallInteger, nullable=False)
    Certificado_Por = db.Column(db.TinyInteger, nullable=False)
    Clues_Certifica = db.Column(db.String(50))
    EntidadFed_Certifica = db.Column(db.TinyInteger, nullable=False)
